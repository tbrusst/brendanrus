/*!
 * vue-simple-markdown v1.0.8
 * (c) 2018 Milan Bačkonja
...
Component.options.__file = "/home/milan/dev/vivify/vue-simple-markdown/src/vue-simple-markdown.component.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a42b9506", Component.options)
  } else {
    hotAPI.reload("data-v-a42b9506", Component.options)
  }
...
var _vueSimpleMarkdownParser = __webpack_require__(18);
...
var _nodeEmoji = __webpack_require__(23);
...
var _highlightjs = __webpack_require__(22);
...
exports.Emoji = exports.Heading = exports.Linkify = exports.Link = exports.Img = exports.Italic = exports.Strong = exports.Quote = exports.Lists = exports.HorizontalLine = exports.InlineCode = exports.Highlight = exports.RULES = undefined;
...
var RULES = [_highlight.Highlight, _inlineCode.InlineCode, _horizontalLine.HorizontalLine, _lists.Lists, _quote.Quote, _strong.Strong, _italic.Italic, _img.Img, _link.Link, _linkify.Linkify, _heading.Heading, _emoji.Emoji, _inlineCode.InlineCode];
...
var ITALIC_REGEX_1 = /(^|\s)(?:_)(.+?)(?:_)($|\s)/g;
var ITALIC_REGEX_2 = /(^|\s)(?:\*)(.+?)(?:\*)($|\s)/g;
...
var Linkify = exports.Linkify = function () {
  ...
  _createClass(Linkify, null, [{
    key: 'parse',
    value: function parse(source) {
      return source.replace(LINK_REGEX, function (all, before, url) {
        url = url.trim();
...
var STRONG_REGEX_1 = /(^|\s)(?:__)(.+?)(?:__)($|\s)/g;
var STRONG_REGEX_2 = /(^|\s)(?:\*\*)(.+?)(?:\*\*)($|\s)/g;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-a42b9506", module.exports)
  }
}
